    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCodeSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCodeSubmissions_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCodeSubmissions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCodeSubmissions_LessonId",
                table: "UserCodeSubmissions",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCodeSubmissions_UserId",
                table: "UserCodeSubmissions",
                column: "UserId");
